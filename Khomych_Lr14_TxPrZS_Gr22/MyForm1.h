...
namespace KhomychLr14TxPrZSGr22 {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ шрифткТекстуToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->шрифткТекстуToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->вебсайтиToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(6) {
				this->колірФонуКнопокToolStripMenuItem,
					...
					this->шрифтКомірокToolStripMenuItem, this->шрифткТекстуToolStripMenuItem
			});
			...
			// 
			// шрифткТекстуToolStripMenuItem
			// 
			this->шрифткТекстуToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Cambria", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->шрифткТекстуToolStripMenuItem->Name = L"шрифткТекстуToolStripMenuItem";
			this->шрифткТекстуToolStripMenuItem->Size = System::Drawing::Size(236, 24);
			this->шрифткТекстуToolStripMenuItem->Text = L"Шрифтк тексту";
			// 
