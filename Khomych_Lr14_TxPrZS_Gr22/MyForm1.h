...
namespace KhomychLr14TxPrZSGr22 {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ вихдToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->вихдToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
				this->вебсайтиToolStripMenuItem,
					this->банківськіКартиToolStripMenuItem, this->безпекаДанихToolStripMenuItem, this->вихдToolStripMenuItem
			});
			...
			// 
			// вихдToolStripMenuItem
			// 
			this->вихдToolStripMenuItem->Name = L"вихдToolStripMenuItem";
			this->вихдToolStripMenuItem->Size = System::Drawing::Size(70, 26);
			this->вихдToolStripMenuItem->Text = L"Вихід";
			// 
			// tabControl1
			// 
